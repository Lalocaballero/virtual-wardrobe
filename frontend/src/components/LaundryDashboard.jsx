  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold  dark:text-white mb-2">🧺 Smart Laundry Assistant</h2>
        <p className=" ">Keep your wardrobe fresh and organized</p>
      </div>

      {/* Wardrobe Health Score */}
      {wardrobeHealth && (
        <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-lg shadow-sm border p-6">
          <div className="text-center">
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
            {laundryAlerts.urgent_items.map(item => (
              <div key={item.id} className="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-lg p-4 shadow-sm">
              ...
              <div key={index} className="border rounded-lg p-4">
                ...
                <div className="flex flex-wrap gap-1 mb-3">
                  {load.items.slice(0, 3).map(item => (
                    <span key={item.id} className="px-2 py-1 bg-gray-100  text-xs rounded">
                      {item.name}
                    </span>
                  ))}
                  {load.items.length > 3 && (
        ...
        <div className="bg-orange-50 border border-orange-200 rounded-lg p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            {laundryAlerts.high_priority.map(item => (
              <div key={item.id} className="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-lg p-3 text-center">
