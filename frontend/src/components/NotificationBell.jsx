    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button onClick={() => setIsOpen(!isOpen)} className="relative p-2 rounded-full hover:bg-muted dark:hover:bg-inkwell">
                <BellIcon className="h-6 w-6 text-slate dark:text-cloud-white" />
                {unreadCount > 0 && (
            ...
            {isOpen && (
                <div className="absolute mt-2 left-1/2 -translate-x-1/2 w-[95vw] max-w-md md:left-auto md:translate-x-0 md:right-0 md:w-80 md:max-w-none bg-card dark:bg-dark-subtle dark:bg-dark-subtle rounded-lg shadow-lg border dark:border-inkwell z-10">
