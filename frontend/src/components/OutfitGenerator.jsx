  ...
  if (!outfit) {
    return (
      <div className="text-center py-8 md:py-12 px-4">
        <div className="mb-6">
          <div className="mx-auto h-20 w-20 md:h-24 md:w-24 bg-primary/10 dark:bg-primary/20 rounded-full flex items-center justify-center mb-4">
          ...
          {outfit.suggestion.reasoning && (
            <div className="bg-secondary/10 dark:bg-secondary/20 border border-secondary/20 rounded-lg p-4 md:p-6">
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <h3 className="font-medium text-foreground mb-2 text-sm md:text-base">Here's the style breakdown:</h3>
                  <p className="text-foreground/80 leading-relaxed text-sm md:text-base">{outfit.suggestion.reasoning}</p>
                </div>
              </div>
            </div>
          )}
          ...
          {outfit.suggestion.style_notes && (
            <div className="bg-accent/10 dark:bg-accent/20 border border-accent/20 rounded-lg p-4 md:p-6">
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <h3 className="font-medium text-foreground mb-2 text-sm md:text-base">Pro tip:</h3>
                  <p className="text-foreground/80 leading-relaxed text-sm md:text-base">{outfit.suggestion.style_notes}</p>
                </div>
              </div>
            </div>
          )}
